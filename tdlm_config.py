...
epoch_size=30 #n_epoch
topic_number=0 #k
word_embedding_size=30 #e; setting ignored if word_embeding_model is provided
# word_embedding_model=None
word_embedding_model="../data/GoogleNews-vectors-negative300.bin" #pre-trained word embedding (gensim format); None if no pre-trained model
...
output_dir="output"
dataset="apnews"
data_path="../data/tdlm_data/" + dataset + "/"
#train_corpus="data/toy-train.txt"
train_corpus=data_path + "train.txt"
...
valid_corpus=data_path + "valid.txt"
